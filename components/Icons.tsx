...
// A helper component to reduce boilerplate for icons
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a1.063 1.063 0 00-1.5 0l-3.72 3.72V13.5c0-1.136.847-2.1 1.98-2.193l3.72-3.72a1.063 1.063 0 001.5 0l3.72 3.72zM3.75 8.25V13.5c0 1.136.847 2.1 1.98 2.193l3.72-3.72a1.063 1.063 0 00-1.5 0L4.23 15.77z" />
  </Icon>
);

export const PresentationChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h.008v.015M3.375 12h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h17.25c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125m-17.25 0h.008v.015m-1.133-3.838V4.5a1.125 1.125 0 011.125-1.125h1.5c.621 0 1.125.504 1.125 1.125v7.5m-3.75 0h.008v.015m1.125-7.5h1.5m-1.5 0h.008v.015m5.625 7.5h1.5m-1.5 0h.008v.015m5.625 7.5h1.5m-1.5 0h.008v.015m-1.125-7.5h.008v.015m5.625 0h.008v.015" />
  </Icon>
);

export const DocumentMagnifyingGlassIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25l-2.025-2.025a3.75 3.75 0 00-5.304 0l-4.5 4.5a3.75 3.75 0 000 5.304l2.025 2.025a3.75 3.75 0 005.304 0l4.5-4.5a3.75 3.75 0 000-5.304zm-7.5-3.75a3.75 3.75 0 00-5.303-5.303l-1.125 1.125a3.75 3.75 0 005.303 5.303l1.125-1.125z" />
  </Icon>
);
...
// FIX: Add missing DocumentIcon component.
...
// FIX: Add missing DocumentDuplicateIcon and ArrowLeftIcon for ConverterView.
export const DocumentDuplicateIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <Icon {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375V9.375a2.25 2.25 0 00-2.25-2.25H9.375m-3.75 0V5.625c0-.621.504-1.125 1.125-1.125h9.75c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125m0-9.75h9.75" />
  </Icon>
);
